...
ul.addEventListener('click', (event) => 
{
    if(event.target.tagName === 'BUTTON') 
    {
    ...
    else if(button.textContent === 'Edit') 
     {
         ...
         char2=ul.removeChild(li);
         check=char2.id;
        axios.get(`https://crudcrud.com/api/344e2b03ebe74c71849c8fa008e13fe9/AppointmentData1/${char2.id}`)
        .then((response)=>{
...
btn.addEventListener('click',e=>
{
    ...
    if(check!=0)
    {
        axios.put(`https://crudcrud.com/api/344e2b03ebe74c71849c8fa008e13fe9/AppointmentData1/${char2.id}`, 
    {
        name:userName,
        email:userEmail
    }
